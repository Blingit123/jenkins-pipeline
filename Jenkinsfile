    ...
    stages {
        ...
        stage('Docker Image Tag') {
            steps {
                ...
                sh 'docker tag imageversion 277707117251.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
            }
        }
        ...
        stage('Push Image') {  
            steps {
                sh 'docker push 277707117251.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:latest'
                 sh 'docker push 277707117251.dkr.ecr.us-east-1.amazonaws.com/jenkins-ci:v1.$BUILD_NUMBER'
            }
            }
        }
    }
